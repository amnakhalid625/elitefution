...
import menuBg from '../assets/images/make-better.png';
    ...
    >
      <div className="bg-black bg-opacity-60">
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <button className="relative inline-flex items-center px-6 py-3 text-sm font-medium text-white group w-40 justify-center bg-transparent border-0">
